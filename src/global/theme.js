...
const secondaryColors = {
  darkBlue: '#00273E', // dark blue
  green: '#57C1A5', // aqua / green / teal
  grey: '#E6E7E8', // grey
  lightBlue: '#76C9DD', // light blue
  yellow: '#FBBF2B', // yellow
};
...
export const fontFamily = {
  compressed: "'GT America Compressed', sans-serif",
  condensed: "'GT America Condensed', sans-serif",
  inherit: 'inherit',
  initial: 'initial',
  standard: "'GT America Standard', sans-serif",
};
